...
metrics (
    ...
    TICKETS.HIGH_SEVERITY_TICKETS as COUNT(CASE WHEN tickets.severity_level IN ('Critical', 'High') THEN tickets.ticket_record END) comment='Number of high severity tickets',
    TICKETS.CRITICAL_TICKETS as COUNT(CASE WHEN tickets.severity_level = 'Critical' THEN tickets.ticket_record END) comment='Number of critical tickets'
)
